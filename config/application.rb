...
module MikedllCrm
  class Application < Rails::Application
    ...
    config.assets.precompile += ['application.js', 'application.css', 'home.css', 'home.js', 'client.js', 'manage.js', 'status_page.js', 'contact_page.js', 'gallery.js', 'public.js', 'public.css']
