...
if Rails.env.development?
  ...
  Barista.configure do |c|
    ...
    # c.root = Rails.root.join("public", "coffeescripts")
    
    # Change the output root, causing Barista to compile into public/coffeescripts
    c.output_root = Rails.root.join("public", "javascripts", "generated")
    ...
    # c.verbose = false
    c.exception_on_error!
    
    # Or, make sure it is always on
    c.verbose! if Rails.env.development?
